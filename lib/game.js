...
const GameData = {
	"words" : {
		...
		"Fingon": {
			...
			aliases: [],
			hints: ["He was the eldest son of Fingolfin."],
		...
		"Gandalf": {
			...
			aliases: ["Olórin", "Mithrandir", "Incánus", "Tharkûn", "Greyhame", "Old Greybeard", "the Grey Pilgrim", "Stormcrow", "the White Rider", "Láthspell", "Big Greybeard", "Long Greybeard", "Pointy Hat", "Tall Fellow", "Gandalf the Fool", "The Wondering Wizard"],
			hints: ["Was one of the five Istari, who were Maiar spirits sent to Middle-earth as human forms to aid the Free Peoples against the threat of Sauron."],
		...
		"Manwe": {
			...
			aliases: ["King of Arda, Lord of the Breath of Arda", "King of the Valar",  "Lord of the West", "Lord of Aman"],
		...
		"Finarfin": {
			...
			aliases: [],
			hints: ["He was said to be the fairest and wisest of Finwë's sons."],
		...
		"Ungoliant": {
			...
			hints: ["Name means \'Dark Spider\'", "It is said by some that she came from the Darkness itself that lies about Arda and was once an ally of Melkor when he looked down upon the world with envy."],
		...
		"Nazgul": {
			...
			hints: ["The dreaded ring-servants of the Dark Lord Sauron"],
		...
		"Ingwe": {
			...
			aliases: [],
			hints: ["Was the King of the Vanyar in Valinor and was reckoned as High King of all the Elves."],
		...
		"Melkor": {
			...
			quoteSource: "Quenta Silmarillion: Of the Coming of the Elves and the Captivity of Melkor",
			aliases: ["He who arises in might"],
			hints: ["With Ungoliant, he destroyed the Two Trees of Valinor"],
			image: "./assets/images/Melkor-and-Ungoliant.jpg",
		...
		"Grond": {
			...
			quoteSource: "Quenta Silmarillion: Of the Ruin of Beleriand and the Fall of Fingolfin",
			aliases: ["The Hammer of the Underworld"],
			hints: ["The weapon of Morgoth"],
		...
		"Angband": {
			...
			quoteSource: "Quenta Silmarillion: Of the Coming of the Elves and the Captivity of Melkor",
			aliases: ["Iron Prison"],
			hints: ["This fortress was originally under the command of Sauron"],
		...
		"Silmaril": {
			...
			aliases: ["The Jewels of Feanor"],
			hints: ["gems crafted by Fëanor from some essence of the Two Trees of Valinor"],
		...
		"Utumno": {
			...
			quoteSource: "Quenta Silmarillion: Of the Coming of the Elves and the Captivity of Melkor",
			aliases: [],
			hints: ["The first fortess of Melkor, before the First Age"],
		...
		"Galadriel": {
			...
			aliases: [],
			hints: ["The bearer of Nenya, one of the three Elven rings of power."],
		...
		"Luthien": {
			...
			aliases: ["Tinúviel"],
			hints: ["The most beautiful of the Children of Ilúvatar"],
